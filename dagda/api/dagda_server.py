...
class DagdaServer:
    ...
    def __init__(self, dagda_server_host='127.0.0.1', dagda_server_port=5000, mongodb_host='127.0.0.1',
                 mongodb_port=27017, mongodb_ssl=False, mongodb_user=None, mongodb_pass=None, registry_user=None,
                 registry_pass=None, registry_url=None, falco_rules_filename=None, external_falco_output_filename=None, debug_logging=False):
        ...
        InternalServer.set_docker_driver(registry_user, registry_pass, registry_url)
    ...
    def _check_docker_by_image_name(item):
        ...
        evaluated_docker_image = analyzer.evaluate_image(item['image_name'], None)
          #pass on image digest
        if 'image_digest' in item:
             evaluated_docker_image['image_digest']=item['image_digest']
