...
class InternalServer:
    ...
    # Sets MongoDB Driver
    @staticmethod
    def set_docker_driver(docker_user, docker_pass, docker_registry_url):
        if not docker_user:
            docker_user = None
        if not docker_pass:
            docker_pass = None
        ...
        InternalServer._docker_driver = DockerDriver(docker_user, docker_pass, docker_registry_url)
